        ...
        <div class="col-lg-7">
            ...
            <form role="form" action="{{ route('tickets.store') }}" method="post" enctype="plain">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="name1" placeholder="{{ trans('adminlte_lang::message.yourname') }}">
                    <span class="help-block" style="color: white;">{{ $errors->has('name') ? $errors->first('name') : '' }}</span>
                </div>
                <div class="form-group">
                    <label for="email1">{{ trans('adminlte_lang::message.emailaddress') }}</label>
                    <input type="email" name="email" class="form-control" id="email1" placeholder="{{ trans('adminlte_lang::message.enteremail') }}">
                    <span class="help-block" style="color: white;">{{ $errors->has('email') ? $errors->first('email') : '' }}</span>
                </div>
                <div class="form-group">
                    <label>{{ trans('adminlte_lang::message.yourtext') }}</label>
                    <span class="help-block" style="color: white;">{{ $errors->has('content') ? $errors->first('content') : '' }}</span>
